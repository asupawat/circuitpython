...
//|    .. method:: asbytearray()
//|
//|       Returns an `array.array` object that refers to the same memory.
//|       This can be used with functions and methods that require "buffers",
//|       such as `audiocore.RawSample`.
//|
//|       Despite the name, the byte array preserves the type information of
//|       the array.
//|
...
//|    .. method:: rawsize()
//|
//|       Returns a 5-tuple with the following data
//|
//|       #. number of rows
//|       #. number of columns
//|       #. length of the storage (should be equal to the product of 1. and 2.)
//|       #. length of the data storage in bytes
//|       #. size of one element in bytes
//|
//|       **WARNING:** `rawsize` is a `ulab`-only method; it has no
//|       equivalent in ``numpy``.
//|
//|    .. method:: shape()
//|
